...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_usecols(self):
        ...
        # IBEX 35 with arrays instead of tuples.
        c.seek(0)
        x = np.loadtxt(c, dtype=float, usecols=np.array([1, 2]))
        assert_array_equal(x, a[:, 1:])

        # IBEX 35 with an integer instead of a sequence
        ...
        # IBEX 35 with some crazy custom integer type
